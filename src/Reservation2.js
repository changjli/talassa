        ...
        <div className="home">
            <div className="content">
                ...
                <div className="right-content">
                        ...
                        <div className="container">
                            ...
                            <div className="sub-container">
                                ...
                                <form
                                    ...
                                    className="standing-table-container"
                                >
                                    <div className="table">
                    ...
                    <div className="table-EFGHIJKL">
                        ...
                        <div className="table-EFGHKL">
                            <div className="table-EFK">
                                <form action="" id="table-E-form" className="table-E-container">
                                    <div className="seat seat-1">
                                ...
                                <div className="line" />
                                <form action="" id="table-F-form" className="table-F-container">
                                    <div className="seat seat-1">
                                ...
                                <div className="line" />
                                <form action="" id="table-K-form" className="table-K-container">
                                    <div className="seat seat-1">
                            ...
                            <div className="table-GHL">
                                <form action="" id="table-G-form" className="table-G-container">
                                    <div className="seat seat-1">
                                ...
                                <div className="line" />
                                <form action="" id="table-H-form" className="table-H-container">
                                    <div className="seat seat-1">
                                ...
                                <div className="line" />
                                <form action="" id="table-L-form" className="table-L-container">
                                    <div className="seat seat-1">
                    ...
                    <form action="" id="viproom-form" className="viproom-container">
                    ...
                    <div className="btn">
                        ...
                        <button id="confimation" className="confirm">
                            Confirmation
                        </button>
                        <img src="./Assets/ombak.svg" alt="ombakerror" />
                    </div>
